...
Unicode 字符集支持 BMP（基本多语言平面，U+0000 至 U+FFFF）字符和补充字符（U+10000 及以上）。MySQL 8.4 支持的 Unicode 字符集如下：
...
```sql
SELECT LENGTH('😀') AS byte_length, CHAR_LENGTH('😀') AS char_count, HEX('😀') AS hex_value;
```
...
ALTER TABLE t1 MODIFY col1 VARCHAR(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci;
```
...
WHERE CHARACTER_SET_NAME = 'utf8mb4' AND COLLATION_NAME LIKE '%\_0900%'
...
WHERE COLLATION_NAME IN ('utf8mb4_bin','utf8mb4_0900_bin','utf8mb4_general_ci','utf8mb4_0900_ai_ci');
```
...
```sql
CREATE TABLE g1 (c CHAR(10)) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
