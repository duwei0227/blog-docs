...
### 4.6 外键元数据 INNODB_FOREIGN_COLS 表
...
### 4.7 表空间元数据 INNODB_TABLESPACES 表
...
### 4.8 表空间元数据 INNODB_TABLESPACES_BRIEF 表
...
### 4.10 表统计信息 INNODB_TABLESTATS 表
...
### 4.13 缓冲池信息 INNODB_BUFFER_PAGE 表
...
### 4.14 缓冲池信息 INNODB_BUFFER_PAGE_LRU 表
...
### 4.15 缓冲池信息 INNODB_BUFFER_POOL_STATS 表
...
### 4.16 缓冲池信息 INNODB_CACHED_INDEXES 表
...
### 4.17 全文索引信息 INNODB_FT_INDEX_CACHE 表
...
### 4.18 全文索引信息 INNODB_FT_DELETED 表
...
### 4.19 全文索引信息 INNODB_FT_BEING_DELETED 表
...
### 4.20 全文索引信息 INNODB_FT_CONFIG 表
...
### 4.21 全文索引信息 INNODB_FT_DEFAULT_STOPWORD 表
...
### 4.23 临时表 INNODB_TEMP_TABLE_INFO 表
...
### 4.24 临时表 INNODB_SESSION_TEMP_TABLESPACES 表
