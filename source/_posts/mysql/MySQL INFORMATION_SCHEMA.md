...
### 4.2 InnoDB 表结构元数据 INNODB_COLUMNS 表
...
### 4.3 InnoDB 表结构元数据 INNODB_INDEXES 表
...
### 4.4 InnoDB 表结构元数据 INNODB_FIELDS 表
...
### 4.5 InnoDB 外键元数据 INNODB_FOREIGN 表
...
### 4.6 InnoDB 外键元数据 INNODB_FOREIGN_COLS 表
...
### 4.7 InnoDB 表空间元数据 INNODB_TABLESPACES 表
...
### 4.8 InnoDB 表空间元数据 INNODB_TABLESPACES_BRIEF 表
...
### 4.9 InnoDB 表空间元数据 INNODB_DATAFILES 表
...
### 4.10 InnoDB 表统计信息 INNODB_TABLESTATS 表
...
### 4.12 InnoDB 虚拟生成列 INNODB_VIRTUAL 表
...
### 4.13 InnoDB 缓冲池信息 INNODB_BUFFER_PAGE 表
...
### 4.14 InnoDB 缓冲池信息 INNODB_BUFFER_PAGE_LRU 表
...
### 4.15 InnoDB 缓冲池信息 INNODB_BUFFER_POOL_STATS 表
...
### 4.16 InnoDB 缓冲池信息 INNODB_CACHED_INDEXES 表
...
### 4.17 InnoDB 全文索引信息 INNODB_FT_INDEX_CACHE 表
...
### 4.18 InnoDB 全文索引信息 INNODB_FT_DELETED 表
...
### 4.19 InnoDB 全文索引信息 INNODB_FT_BEING_DELETED 表
...
### 4.20 InnoDB 全文索引信息 INNODB_FT_CONFIG 表
...
### 4.21 InnoDB 全文索引信息 INNODB_FT_DEFAULT_STOPWORD 表
...
### 4.22 InnoDB 性能指标 INNODB_METRICS 表
...
### 4.23 InnoDB 临时表 INNODB_TEMP_TABLE_INFO 表
...
### 4.24 InnoDB 临时表 INNODB_SESSION_TEMP_TABLESPACES 表
