...
### 4.2.2 外键元数据 INNODB_FOREIGN_COLS 表
...
### 4.3.1 表空间元数据 INNODB_TABLESPACES 表
...
### 4.3.2 表空间元数据 INNODB_TABLESPACES_BRIEF 表
...
### 4.3.3 表空间元数据 INNODB_DATAFILES 表
...
### 4.4.1 表统计信息 INNODB_TABLESTATS 表
...
### 4.7.1 缓冲池信息 INNODB_BUFFER_PAGE 表
...
### 4.7.2 缓冲池信息 INNODB_BUFFER_PAGE_LRU 表
...
### 4.7.3 缓冲池信息 INNODB_BUFFER_POOL_STATS 表
...
### 4.7.4 缓冲池信息 INNODB_CACHED_INDEXES 表
