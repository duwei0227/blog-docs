...
### 4.7.2 INNODB_BUFFER_PAGE_LRU 表
...
### 4.7.3 INNODB_BUFFER_POOL_STATS 表
...
### 4.8.3 INNODB_FT_BEING_DELETED 表
...
### 4.8.5 INNODB_FT_DEFAULT_STOPWORD 表
...
## 4.10 临时表
### 4.10.1 INNODB_TEMP_TABLE_INFO 表
...
### 4.10.2 INNODB_SESSION_TEMP_TABLESPACES 表
